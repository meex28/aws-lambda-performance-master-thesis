...
\subsection*{Inne metody / SnapStart}
...
\subsection*{Integracja z zewnętrznymi usługami}

\subsection*{Wielkość funkcji}
...
\subsection*{Odpowiedni język programowania}

\subsection*{Testowanie i debbugowanie}
...
\cite{9027427} - użycie różnych zewnętrznych serwisów, zaproponowana metoda cachowania (https://gemini.google.com/gem/180d518dd570/7e48018efb39bbc2)

\cite{8513710} - używanie różnych języków w zależności od przypadku, różne usługi (https://gemini.google.com/gem/180d518dd570/929ecefb19ed43fe) 

\cite{raza2021sok} - różne decyzje dewelopera jak wybór języka, parametrów itp.

\cite{Cavalheiro202389} - może testowanie, debugging, complexity

\cite{LEITNER2019340} - małe funkcje, trudne testowanie, 

\cite{Ivanov_Petrova_2024} - integracja z innymi serwisami, debuggowanie, testowanie lokalnie

\cite{eismann2021reviewserverlessusecases} - serwisy, wielkość funkcji nie jest zawsze taka sama, 
