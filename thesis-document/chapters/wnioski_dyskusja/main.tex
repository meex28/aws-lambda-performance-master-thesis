...
Istotny jest także fakt, że GraalVM cechował się pewną niestabilnością, objawiającą się wysokimi wartościami odchyleń standardowych.
Może to świadczyć o niestabilności natywnych obrazów GraalVM.
...
W ramach badania starano się zminimalizować ten wpływ, np. poprzez brak integracji z zewnętrznymi serwisami oraz przeprowadzenie analizy statystycznej.
